...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
    return (
        <div className="relative grid min-h-screen bg-[#0f0f10] lg:grid-cols-2">
            ...
            <div className="flex w-full flex-col items-center justify-start overflow-y-scroll p-4 [scrollbar-width:none] sm:p-12 lg:h-screen lg:justify-center lg:p-24 [&::-webkit-scrollbar]:hidden">
