...
/**
 * Component representing the list of active conversations and user directory search.
 *
 * @param props Props containing conversations, search queries, toggle state and selection handlers.
 * @returns React element representing the conversation sidebar list.
 */
