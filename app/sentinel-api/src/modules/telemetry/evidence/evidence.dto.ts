 ...
 */
export const TelemetryIncidentEvidenceStateSchema = z
    .enum(['PENDING_UPLOAD', 'AVAILABLE', 'DELETE_PENDING', 'DELETED', 'FAILED', 'EXPIRED'])
    .openapi('TelemetryIncidentEvidenceState');

/**
 * Zod schema for telemetry incident evidence event type.
 */
export const TelemetryEvidenceEventTypeSchema = z
    .nativeEnum(incident_type)
    .openapi('TelemetryEvidenceEventType');
...
const mediaPipeEvidenceCaptureSchema = z
    .object({
...
const mediaPipeEvidenceUploadTargetSchema = z
    .object({
...
export const ingestEvidenceCandidateSchema = {
    body: z
        .object({
            ...
            ruleKey: z.enum(TelemetryRuleKeySchema.options).openapi({
 ...
 * lifecycle.
 */
export type InitializeEvidenceUploadResponse = z.infer<
    typeof initializeEvidenceUploadSchema.response
>;
 ...
 */
export type IngestEvidenceCandidateResponse = z.infer<
    typeof ingestEvidenceCandidateSchema.response
>;
