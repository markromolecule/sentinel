...
describe('ExamReportPdfExport', () => {
    ...
    it('renders ready, failed, and expired terminal states', () => {
        ...
        mockExportsQuery.mockReturnValueOnce({
            data: {
                records: [{ exportId: 'export-1', status: 'EXPIRED', failureMessage: null }],
                total_records: 1,
                page: 1,
                limit: 1,
            },
    ...
    it('retries and deletes using the active export id', () => {
        mockExportsQuery.mockReturnValue({
            data: {
                records: [
                    {
    ...
    it('opens signed urls only on explicit download', async () => {
        mockExportsQuery.mockReturnValue({
            data: {
                records: [{ exportId: 'export-1', status: 'READY', failureMessage: null }],
                total_records: 1,
