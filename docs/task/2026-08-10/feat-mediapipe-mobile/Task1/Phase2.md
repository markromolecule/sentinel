...
- [x] **Create** `app/sentinel-mobile/features/exam/hooks/use-mobile-mediapipe-monitoring.ts`
    ...
    - Dispatch telemetry events (`GAZE_OFF_SCREEN`, `MULTIPLE_FACES`, `NO_FACE_DETECTED`) via `emitMobileTelemetryEvent`.
    - Expose warning status state for UI overlay ("Face not detected", "Multiple faces detected", "Looking away from screen").
- [x] **Write unit tests** at `app/sentinel-mobile/features/exam/hooks/use-mobile-mediapipe-monitoring.test.ts`
...
- [x] **Create** `app/sentinel-mobile/features/exam/lib/mobile-frame-capture.ts`
...
- [x] **Write unit tests** at `app/sentinel-mobile/features/exam/lib/mobile-frame-capture.test.ts`
...
- [x] **Create** `app/sentinel-mobile/features/exam/components/session/mobile-live-inspection-bridge.tsx`
...
- [x] **Write unit tests** at `app/sentinel-mobile/features/exam/components/session/mobile-live-inspection-bridge.test.tsx`
    - Test bridge render state when proctor is inspecting vs inactive.

### Session Integration

- [x] **Update** `app/sentinel-mobile/features/exam/components/session/exam-session-screen.tsx`
